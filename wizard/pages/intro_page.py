...
class IntroPage(QtWidgets.QWidget):
    def __init__(self):
        ...
        title = QtWidgets.QLabel(
            "<h2>{}</h2>".format(
                QCoreApplication.translate("PluginBuilderEnterprise", "Welcome to Plugin Builder Enterprise")
            )
        )
        ...
        desc = QtWidgets.QLabel(
            QCoreApplication.translate(
                ...
                "<h3>Options</h3>"
                "<p>Here you can choose: license type (MIT or GPL v3), whether to generate a CHANGELOG, "
